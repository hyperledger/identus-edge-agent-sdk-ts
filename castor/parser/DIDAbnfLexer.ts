...
export class DIDAbnfLexer extends Lexer {
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    DIDAbnfLexer._LITERAL_NAMES,
    DIDAbnfLexer._SYMBOLIC_NAMES,
    []
  );
  ...
  public static get _ATN(): ATN {
    if (!DIDAbnfLexer.__ATN) {
      DIDAbnfLexer.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(DIDAbnfLexer._serializedATN)
      );
    }
