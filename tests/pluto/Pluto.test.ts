...
import DIDEntry from '../../pluto/entities/DID';
...
describe('Pluto tests', () => {
  ...
  it('should store prism DID', async function () {
    ...
    console.log(instance.dataSource.isInitialized, ' => initialised');
    console.log(instance.dataSource.hasMetadata(DIDEntry), ' => has DID metadata');
    console.log(instance.dataSource.hasMetadata(DIDEntry), ' => has DID metadata');
