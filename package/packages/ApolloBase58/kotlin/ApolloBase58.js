(function (_, kotlin_com_ionspin_kotlin_bignum, kotlin_kotlin) {
  ...
  function get_base58BtcDecoded(_this__u8e3s4) {
    return get_base58BtcEncoded_0(concatToString(asCharArray(_this__u8e3s4)));
  }
  function get_base58FlickrEncoded(_this__u8e3s4) {
    return Base58_getInstance().encode_rzx63_k$(_this__u8e3s4, Flickr_getInstance());
  }
  function get_base58FlickrDecoded(_this__u8e3s4) {
    return get_base58FlickrEncoded_0(concatToString(asCharArray(_this__u8e3s4)));
  }
  function BTC() {
    BTC_instance = this;
  ...
  function get_base58BtcEncoded_0(_this__u8e3s4) {
    var tmp = Base58_getInstance();
    var tmp_0 = encodeToByteArray(_this__u8e3s4);
    return tmp.encode$default_nlab4l_k$(tmp_0, null, 2, null);
  }
  function get_base58BtcDecodedBytes(_this__u8e3s4) {
    var tmp = Base58_getInstance();
    return tmp.decode$default_s9babp_k$(_this__u8e3s4, null, 2, null);
  }
  function get_base58BtcDecoded_0(_this__u8e3s4) {
    return decodeToString(get_base58BtcDecodedBytes(_this__u8e3s4));
  }
  function get_base58FlickrEncoded_0(_this__u8e3s4) {
    return Base58_getInstance().encode_rzx63_k$(encodeToByteArray(_this__u8e3s4), Flickr_getInstance());
  }
  ...
  function get_base58FlickrDecoded_0(_this__u8e3s4) {
    return decodeToString(get_base58FlickrDecodedBytes(_this__u8e3s4));
  }
  return _;
