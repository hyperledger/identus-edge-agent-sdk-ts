...
(function (root, factory) {
  ...
  function hasPassedNow() {
    return !Duration__isNegative_impl_pbysfa(this.elapsedNow_eypfn4_k$());
  }
  ...
  function last_1(_this__u8e3s4) {
    ...
    return charSequenceGet(_this__u8e3s4, get_lastIndex_5(_this__u8e3s4));
  }
  ...
  function compareValuesBy(a, b, selectors) {
    // Inline function 'kotlin.require' call
    var tmp0_require = selectors.length > 0;
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!tmp0_require) {
  ...
  function compareValuesByImpl(a, b, selectors) {
    var indexedObject = selectors;
    var inductionVariable = 0;
    var last = indexedObject.length;
    while (inductionVariable < last) {
      var fn = indexedObject[inductionVariable];
      inductionVariable = inductionVariable + 1 | 0;
      var v1 = fn(a);
      var v2 = fn(b);
      ...
      $l$block: {
        ...
        if (0 <= inductionVariable)
          do {
            ...
            tmp$ret$0 = !equals_0(new Char_0(tmp0__anonymous__q1qw7t), new Char_0(_Char___init__impl__6a9atx(48)));
            if (tmp$ret$0) {
              tmp$ret$1 = index;
              break $l$block;
            }
  ...
  function parseDuration(value, strictIso) {
    ...
    if (equals_0(new Char_0(tmp0_subject), new Char_0(_Char___init__impl__6a9atx(43))) ? true : equals_0(new Char_0(tmp0_subject), new Char_0(_Char___init__impl__6a9atx(45)))) {
      var tmp1 = index;
      index = tmp1 + 1 | 0;
    }
    var hasSign = index > 0;
    ...
    if (length <= index)
      ...
      if (equals_0(new Char_0(charSequenceGet(value, index)), new Char_0(_Char___init__impl__6a9atx(80)))) {
        index = index + 1 | 0;
        if (index === length)
        ...
        $l$loop: while (index < length) {
          if (equals_0(new Char_0(charSequenceGet(value, index)), new Char_0(_Char___init__impl__6a9atx(84)))) {
            var tmp_1;
            if (isTimeComponent) {
              tmp_1 = true;
            } else {
          ...
          var tmp_4;
          if (tmp3_getOrElse >= 0 ? tmp3_getOrElse <= get_lastIndex_5(value) : false) {
        ...
        if (strictIso)
          ...
          if (regionMatches(value, tmp_7, infinityString, 0, tmp$ret$11, true)) {
            ...
            if ((hasSign ? equals_0(new Char_0(charSequenceGet(value, index)), new Char_0(_Char___init__impl__6a9atx(40))) : false) ? equals_0(new Char_0(last_1(value)), new Char_0(_Char___init__impl__6a9atx(41))) : false) {
              allowSpaces = true;
              index = index + 1 | 0;
              var tmp_8 = index;
              length = length - 1 | 0;
            ...
            while (index < length) {
              if (afterFirst ? allowSpaces : false) {
                ...
                $l$loop_1: while (true) {
                  ...
                  if (i_0 < value.length) {
                    ...
                    tmp$ret$12 = equals_0(new Char_0(tmp7__anonymous__b0knam), new Char_0(_Char___init__impl__6a9atx(32)));
                    tmp_9 = tmp$ret$12;
                  } else {
                    tmp_9 = false;
                  }
              ...
              $l$loop_2: while (true) {
                ...
                if (i_1 < value.length) {
                  ...
                  tmp$ret$14 = (_Char___init__impl__6a9atx(48) <= tmp10__anonymous__yfiz50 ? tmp10__anonymous__yfiz50 <= _Char___init__impl__6a9atx(57) : false) ? true : equals_0(new Char_0(tmp10__anonymous__yfiz50), new Char_0(_Char___init__impl__6a9atx(46)));
                  tmp_10 = tmp$ret$14;
                } else {
                  tmp_10 = false;
                }
  ...
  function parseOverLongIsoComponent(value) {
    ...
    if ((length - startIndex | 0) > 16) {
      ...
      $l$block_0: {
        // Inline function 'kotlin.collections.all' call
        var tmp0_all = numberRangeToNumber(startIndex, get_lastIndex_5(value));
        var tmp_2;
        if (isInterface(tmp0_all, Collection)) {
    ...
    if (tmp_1) {
      var tmp_3;
      if (equals_0(new Char_0(charSequenceGet(value, 0)), new Char_0(_Char___init__impl__6a9atx(45)))) {
        Companion_getInstance_23();
  ...
  function durationUnitByIsoChar(isoChar, isTimeComponent) {
    ...
    if (!isTimeComponent) {
      ...
      var tmp_0;
      if (equals_0(new Char_0(tmp0_subject), new Char_0(_Char___init__impl__6a9atx(68)))) {
      ...
      var tmp_1;
      if (equals_0(new Char_0(tmp1_subject), new Char_0(_Char___init__impl__6a9atx(72)))) {
        tmp_1 = DurationUnit_HOURS_getInstance();
      } else if (equals_0(new Char_0(tmp1_subject), new Char_0(_Char___init__impl__6a9atx(77)))) {
        tmp_1 = DurationUnit_MINUTES_getInstance();
      } else if (equals_0(new Char_0(tmp1_subject), new Char_0(_Char___init__impl__6a9atx(83)))) {
  ...
  function ValueTimeMark__elapsedNow_impl_eonqvs($this) {
    return MonotonicTimeSource_getInstance().elapsedFrom_nuj3fw_k$($this);
  }
  function ValueTimeMark__plus_impl_l3v2m0($this, duration) {
    return MonotonicTimeSource_getInstance().adjustReading_c4njw9_k$($this, duration);
  }
  ...
  function ValueTimeMark__minus_impl_f87sko($this, duration) {
    return MonotonicTimeSource_getInstance().adjustReading_c4njw9_k$($this, Duration__unaryMinus_impl_x2k1y0(duration));
  }
  ...
  function ValueTimeMark__toString_impl_ow3ax6($this) {
    return 'ValueTimeMark(reading=' + toString_3($this) + ')';
  }
  ...
  ValueTimeMark.prototype.elapsedNow_eypfn4_k$ = function () {
    return ValueTimeMark__elapsedNow_impl_eonqvs(this.reading_1);
  };
  ValueTimeMark.prototype.plus_fd9tpa_k$ = function (duration) {
    return ValueTimeMark__plus_impl_l3v2m0(this.reading_1, duration);
  };
  ValueTimeMark.prototype.plus_bswwzx_k$ = function (duration) {
    return ValueTimeMark__plus_impl_l3v2m0_0(this, duration);
  };
  ValueTimeMark.prototype.minus_qjetvw_k$ = function (duration) {
    return ValueTimeMark__minus_impl_f87sko(this.reading_1, duration);
  };
  ValueTimeMark.prototype.minus_luqxh3_k$ = function (duration) {
    return ValueTimeMark__minus_impl_f87sko_0(this, duration);
  };
  ValueTimeMark.prototype.hasPassedNow_xld644_k$ = function () {
    return ValueTimeMark__hasPassedNow_impl_lwbbvu(this.reading_1);
  };
  ValueTimeMark.prototype.hasNotPassedNow_56wlf1_k$ = function () {
  ...
  Monotonic.prototype.markNow_4y2yhq_k$ = function () {
    return MonotonicTimeSource_getInstance().markNow_4y2yhq_k$();
  };
  Monotonic.prototype.markNow_dvnky1_k$ = function () {
    return new ValueTimeMark(this.markNow_4y2yhq_k$());
  };
  Monotonic.prototype.toString = function () {
    return toString_3(MonotonicTimeSource_getInstance());
  };
  ...
  AdjustedTimeMark.prototype.get_mark_woqbrq_k$ = function () {
    return this.mark_1;
  };
  AdjustedTimeMark.prototype.get_adjustment_vr8mr0_k$ = function () {
    return this.adjustment_1;
  };
  AdjustedTimeMark.prototype.elapsedNow_eypfn4_k$ = function () {
    return Duration__minus_impl_q5cfm7(this.mark_1.elapsedNow_eypfn4_k$(), this.adjustment_1);
  };
  AdjustedTimeMark.prototype.plus_bswwzx_k$ = function (duration) {
    return new AdjustedTimeMark(this.mark_1, Duration__plus_impl_yu9v8f(this.adjustment_1, duration));
  };
  AdjustedTimeMark.$metadata$ = classMeta('AdjustedTimeMark', [TimeMark]);
  function _get_startedAt__ngvo71($this) {
    return $this.startedAt_1;
  }
  function _get_timeSource__i1au6b($this) {
    return $this.timeSource_1;
  }
  function _get_offset__c6qzmg($this) {
    return $this.offset_1;
  }
  function LongTimeMark(startedAt, timeSource, offset) {
    this.startedAt_1 = startedAt;
    this.timeSource_1 = timeSource;
    this.offset_1 = offset;
  }
  LongTimeMark.prototype.elapsedNow_eypfn4_k$ = function () {
    return Duration__minus_impl_q5cfm7(toDuration(this.timeSource_1.read_22xsm_k$().minus_llf5ei_k$(this.startedAt_1), this.timeSource_1.unit_1), this.offset_1);
  };
  LongTimeMark.prototype.plus_bswwzx_k$ = function (duration) {
    return new LongTimeMark(this.startedAt_1, this.timeSource_1, Duration__plus_impl_yu9v8f(this.offset_1, duration));
  };
  LongTimeMark.$metadata$ = classMeta('LongTimeMark', [TimeMark]);
  function AbstractLongTimeSource(unit) {
    this.unit_1 = unit;
  }
  AbstractLongTimeSource.prototype.get_unit_wovp3h_k$ = function () {
    return this.unit_1;
  };
  AbstractLongTimeSource.prototype.markNow_dvnky1_k$ = function () {
    return new LongTimeMark(this.read_22xsm_k$(), this, Companion_getInstance_10().ZERO_1);
  };
  AbstractLongTimeSource.$metadata$ = classMeta('AbstractLongTimeSource', [TimeSource]);
  ...
  function MonotonicTimeSource() {
    ...
    tmp$ret$3 = tmp_0;
    tmp$ret$4 = tmp$ret$3;
    tmp.actualSource_1 = tmp$ret$4;
  }
  MonotonicTimeSource.prototype.markNow_4y2yhq_k$ = function () {
    return this.actualSource_1.markNow_4y2yhq_k$();
  };
  MonotonicTimeSource.prototype.markNow_dvnky1_k$ = function () {
    return new ValueTimeMark(this.markNow_4y2yhq_k$());
  };
  MonotonicTimeSource.prototype.elapsedFrom_nuj3fw_k$ = function (timeMark) {
    return this.actualSource_1.elapsedFrom_nuj3fw_k$(timeMark);
  };
  MonotonicTimeSource.prototype.adjustReading_c4njw9_k$ = function (timeMark, duration) {
    return this.actualSource_1.adjustReading_c4njw9_k$(timeMark, duration);
  };
  ...
  HrTimeSource.prototype.markNow_4y2yhq_k$ = function () {
    return _ValueTimeMark___init__impl__uyfl2m(this.process_1.hrtime());
  };
  HrTimeSource.prototype.markNow_dvnky1_k$ = function () {
    return new ValueTimeMark(this.markNow_4y2yhq_k$());
  };
  HrTimeSource.prototype.elapsedFrom_nuj3fw_k$ = function (timeMark) {
    var tmp$ret$3;
    // Inline function 'kotlin.let' call
    var tmp = _ValueTimeMark___get_reading__impl__5qz8rd(timeMark);
    var tmp0_let = this.process_1.hrtime(isArray(tmp) ? tmp : THROW_CCE());
    // Inline function 'kotlin.contracts.contract' call
    var tmp$ret$2;
  ...
  HrTimeSource.prototype.adjustReading_c4njw9_k$ = function (timeMark, duration) {
    var tmp$ret$10;
    // Inline function 'kotlin.let' call
    var tmp$ret$9;
    // Inline function 'kotlin.let' call
    var tmp = _ValueTimeMark___get_reading__impl__5qz8rd(timeMark);
    var tmp0_let = isArray(tmp) ? tmp : THROW_CCE();
    // Inline function 'kotlin.contracts.contract' call
    var tmp$ret$8;
    ...
    var tmp0_truncate = Duration__toDouble_impl_a56y2b(duration, DurationUnit_SECONDS_getInstance());
    tmp$ret$2 = trunc(tmp0_truncate);
    var tmp1_arrayOf = [sumCheckNaN(seconds + tmp$ret$2), nanos + tmp1__anonymous__uwfjfc];
    var tmp$ret$4;
    // Inline function 'kotlin.js.unsafeCast' call
    var tmp$ret$3;
    // Inline function 'kotlin.js.asDynamic' call
    ...
    tmp$ret$8 = tmp$ret$7;
    tmp$ret$9 = tmp$ret$8;
    var tmp1_let = tmp$ret$9;
    // Inline function 'kotlin.contracts.contract' call
    tmp$ret$10 = _ValueTimeMark___init__impl__uyfl2m(tmp1_let);
    return tmp$ret$10;
  };
  ...
  PerformanceTimeSource.prototype.get_performance_al6m9l_k$ = function () {
    return this.performance_1;
  };
  PerformanceTimeSource.prototype.markNow_4y2yhq_k$ = function () {
    return _ValueTimeMark___init__impl__uyfl2m(read(this));
  };
  PerformanceTimeSource.prototype.markNow_dvnky1_k$ = function () {
    return new ValueTimeMark(this.markNow_4y2yhq_k$());
  };
  PerformanceTimeSource.prototype.elapsedFrom_nuj3fw_k$ = function (timeMark) {
    var tmp$ret$0;
    // Inline function 'kotlin.time.Companion.milliseconds' call
    var tmp0__get_milliseconds__kazo1t = Companion_getInstance_10();
    var tmp = read(this);
  ...
  PerformanceTimeSource.prototype.adjustReading_c4njw9_k$ = function (timeMark, duration) {
    var tmp = _ValueTimeMark___get_reading__impl__5qz8rd(timeMark);
  ...
  DateNowTimeSource.prototype.markNow_4y2yhq_k$ = function () {
    return _ValueTimeMark___init__impl__uyfl2m(read_0(this));
  };
  DateNowTimeSource.prototype.markNow_dvnky1_k$ = function () {
    return new ValueTimeMark(this.markNow_4y2yhq_k$());
  };
  DateNowTimeSource.prototype.elapsedFrom_nuj3fw_k$ = function (timeMark) {
    var tmp$ret$0;
    // Inline function 'kotlin.time.Companion.milliseconds' call
    var tmp0__get_milliseconds__kazo1t = Companion_getInstance_10();
    var tmp = read_0(this);
  ...
  DateNowTimeSource.prototype.adjustReading_c4njw9_k$ = function (timeMark, duration) {
    var tmp = _ValueTimeMark___get_reading__impl__5qz8rd(timeMark);
    return _ValueTimeMark___init__impl__uyfl2m(sumCheckNaN((typeof tmp === 'number' ? tmp : THROW_CCE()) + Duration__toDouble_impl_a56y2b(duration, DurationUnit_MILLISECONDS_getInstance())));
  };
  ...
  function fill$default_2(_this__u8e3s4, element, fromIndex, toIndex, $mask0, $handler) {
    if (!(($mask0 & 2) === 0))
      fromIndex = 0;
    if (!(($mask0 & 4) === 0))
      toIndex = _this__u8e3s4.length;
    return fill_2(_this__u8e3s4, element, fromIndex, toIndex);
  }
  ...
  function createCoroutineUnintercepted_0(_this__u8e3s4, completion) {
    var tmp$ret$0;
    // Inline function 'kotlin.coroutines.intrinsics.createCoroutineFromSuspendFunction' call
    tmp$ret$0 = new _no_name_provided__qut3iv_4(completion, _this__u8e3s4);
    return tmp$ret$0;
  }
  ...
  _no_name_provided__qut3iv_3.prototype.doResume_5yljmg_k$ = function () {
  ...
  function _no_name_provided__qut3iv_4($completion, $this_createCoroutineUnintercepted) {
    this.$completion_1 = $completion;
    this.$this_createCoroutineUnintercepted_1 = $this_createCoroutineUnintercepted;
    CoroutineImpl.call(this, isInterface($completion, Continuation) ? $completion : THROW_CCE());
  }
  _no_name_provided__qut3iv_4.prototype.doResume_5yljmg_k$ = function () {
    if (this.exception_1 != null)
      throw this.exception_1;
    var tmp$ret$1;
    // Inline function 'kotlin.coroutines.intrinsics.createCoroutineUnintercepted.<anonymous>' call
  ...
  AdjustedTimeMark.prototype.minus_luqxh3_k$ = minus;
  AdjustedTimeMark.prototype.hasPassedNow_xld644_k$ = hasPassedNow;
  AdjustedTimeMark.prototype.hasNotPassedNow_56wlf1_k$ = hasNotPassedNow;
  LongTimeMark.prototype.minus_luqxh3_k$ = minus;
  LongTimeMark.prototype.hasPassedNow_xld644_k$ = hasPassedNow;
  LongTimeMark.prototype.hasNotPassedNow_56wlf1_k$ = hasNotPassedNow;
  ...
  _.$_$.e = fill$default_1;
  _.$_$.f = fill$default_0;
  _.$_$.g = fill$default;
  _.$_$.h = fill$default_2;
  ...
  _.$_$.q = AssertionError_init_$Init$_0;
  _.$_$.r = AssertionError_init_$Create$_2;
  _.$_$.s = Error_init_$Init$_1;
  _.$_$.t = IllegalArgumentException_init_$Create$_0;
  _.$_$.u = IllegalStateException_init_$Init$_0;
  _.$_$.v = IllegalStateException_init_$Create$_0;
  _.$_$.w = IllegalStateException_init_$Create$_1;
  _.$_$.x = NoSuchElementException_init_$Init$_0;
  ...
  _.$_$.d1 = _Result___init__impl__xyqfz8;
  _.$_$.e1 = Result__exceptionOrNull_impl_p6xea9;
  ...
  _.$_$.k1 = Companion_getInstance_23;
  _.$_$.l1 = Companion_getInstance_12;
  ...
  _.$_$.z1 = sliceArray;
  _.$_$.a2 = toByteArray;
  _.$_$.b2 = compareValuesBy;
  _.$_$.c2 = CancellationException;
  _.$_$.d2 = get_COROUTINE_SUSPENDED;
  _.$_$.e2 = createCoroutineUnintercepted_0;
  _.$_$.f2 = createCoroutineUnintercepted;
  _.$_$.g2 = intercepted;
  _.$_$.h2 = AbstractCoroutineContextElement;
  _.$_$.i2 = AbstractCoroutineContextKey;
  _.$_$.j2 = get_0;
  _.$_$.k2 = minusKey_0;
  _.$_$.l2 = ContinuationInterceptor;
  _.$_$.m2 = Continuation;
  _.$_$.n2 = fold;
  _.$_$.o2 = get;
  _.$_$.p2 = minusKey;
  ...
  _.$_$.r2 = Key_0;
  _.$_$.s2 = plus;
  _.$_$.t2 = CoroutineImpl;
  _.$_$.u2 = SuspendFunction0;
  _.$_$.v2 = SuspendFunction1;
  _.$_$.w2 = startCoroutine;
  _.$_$.x2 = startCoroutine_0;
  _.$_$.y2 = anyToString;
  _.$_$.z2 = captureStack;
  _.$_$.a3 = classMeta;
  _.$_$.b3 = compareTo_0;
  _.$_$.c3 = equals_0;
  _.$_$.d3 = fillArrayVal;
  _.$_$.e3 = getPropertyCallableRef;
  _.$_$.f3 = getStringHashCode;
  _.$_$.g3 = hashCode_0;
  _.$_$.h3 = interfaceMeta;
  _.$_$.i3 = isArray;
  _.$_$.j3 = isInterface;
  _.$_$.k3 = isObject;
  _.$_$.l3 = isSuspendFunction;
  _.$_$.m3 = longArrayOf_0;
  _.$_$.n3 = longArray;
  _.$_$.o3 = numberToByte;
  _.$_$.p3 = objectMeta;
  _.$_$.q3 = toByte;
  ...
  _.$_$.u3 = until;
  _.$_$.v3 = KProperty1;
  _.$_$.w3 = SequenceScope;
  _.$_$.x3 = filter;
  _.$_$.y3 = sequence;
  _.$_$.z3 = toList_0;
  _.$_$.a4 = encodeToByteArray;
  _.$_$.b4 = padStart;
  _.$_$.c4 = repeat_0;
  _.$_$.d4 = toInt;
  _.$_$.e4 = toLongOrNull;
  _.$_$.f4 = toString_0;
  _.$_$.g4 = AbstractLongTimeSource;
  _.$_$.h4 = Annotation;
  _.$_$.i4 = AssertionError;
  _.$_$.j4 = Comparable;
  _.$_$.k4 = Enum;
  _.$_$.l4 = Error_0;
  _.$_$.m4 = IllegalStateException;
  _.$_$.n4 = Long;
  _.$_$.o4 = NoSuchElementException;
  _.$_$.p4 = NotImplementedError;
  _.$_$.q4 = RuntimeException;
  _.$_$.r4 = THROW_CCE;
  _.$_$.s4 = THROW_ISE;
  _.$_$.t4 = Unit;
  _.$_$.u4 = UnsupportedOperationException;
  _.$_$.v4 = addSuppressed;
  _.$_$.w4 = createFailure;
  _.$_$.x4 = ensureNotNull;
  _.$_$.y4 = noWhenBranchMatchedException;
  _.$_$.z4 = rotateLeft_0;
  _.$_$.a5 = rotateLeft;
  _.$_$.b5 = rotateRight;
  _.$_$.c5 = throwUninitializedPropertyAccessException;
  _.$_$.d5 = toString_2;
  _.$_$.e5 = to;
  //endregion
  return _;
