(function (_, kotlin_kotlin) {
  ...
  var toByte = kotlin_kotlin.$_$.n;
  var toString = kotlin_kotlin.$_$.q;
  var fill$default = kotlin_kotlin.$_$.a;
  var Char__toInt_impl_vasixd = kotlin_kotlin.$_$.d;
  var objectMeta = kotlin_kotlin.$_$.m;
  var ensureNotNull = kotlin_kotlin.$_$.r;
  var _Char___init__impl__6a9atx = kotlin_kotlin.$_$.c;
  var charArrayOf = kotlin_kotlin.$_$.g;
  var arrayCopy = kotlin_kotlin.$_$.f;
  var encodeToByteArray = kotlin_kotlin.$_$.p;
  var classMeta = kotlin_kotlin.$_$.i;
  var decodeToString = kotlin_kotlin.$_$.o;
  var noWhenBranchMatchedException = kotlin_kotlin.$_$.s;
  var equals = kotlin_kotlin.$_$.j;
  var charArray = kotlin_kotlin.$_$.h;
  var numberToChar = kotlin_kotlin.$_$.l;
  var interfaceMeta = kotlin_kotlin.$_$.k;
  //endregion
  ...
  function get_base64Encoded(_this__u8e3s4) {
    var tmp = Base64_getInstance();
    return tmp.encodeToString$default_f8jw6e_k$(_this__u8e3s4, null, 2, null);
  }
  function get_base64Decoded(_this__u8e3s4) {
    var tmp = Base64_getInstance();
    var tmp_0 = decodeToString(_this__u8e3s4);
    return decodeToString(tmp.decode$default_3gwegw_k$(tmp_0, null, 2, null));
  }
  ...
  function get_base64PadDecoded(_this__u8e3s4) {
    return decodeToString(Base64_getInstance().decode_xxjwh2_k$(decodeToString(_this__u8e3s4), StandardPad_getInstance()));
  }
  function get_base64UrlDecoded(_this__u8e3s4) {
    return decodeToString(Base64_getInstance().decode_xxjwh2_k$(decodeToString(_this__u8e3s4), UrlSafe_getInstance()));
  }
  function get_base64UrlEncoded(_this__u8e3s4) {
    return Base64_getInstance().encodeToString_4ettju_k$(_this__u8e3s4, UrlSafe_getInstance());
  }
  function get_base64UrlPadDecoded(_this__u8e3s4) {
    return Base64_getInstance().encodeToString_4ettju_k$(_this__u8e3s4, UrlSafePad_getInstance());
  }
  function get_base64UrlPadEncoded(_this__u8e3s4) {
    return Base64_getInstance().encodeToString_4ettju_k$(_this__u8e3s4, UrlSafePad_getInstance());
  }
  function Standard() {
  ...
  function get_base64Encoded_0(_this__u8e3s4) {
    return Base64_getInstance().encodeToString_4ettju_k$(encodeToByteArray(_this__u8e3s4), Standard_getInstance());
  }
  function get_base64Decoded_0(_this__u8e3s4) {
    return decodeToString(Base64_getInstance().decode_xxjwh2_k$(_this__u8e3s4, Standard_getInstance()));
  }
  function get_base64DecodedBytes(_this__u8e3s4) {
    return Base64_getInstance().decode_xxjwh2_k$(_this__u8e3s4, Standard_getInstance());
  }
  function get_base64PadEncoded_0(_this__u8e3s4) {
    return Base64_getInstance().encodeToString_4ettju_k$(encodeToByteArray(_this__u8e3s4), StandardPad_getInstance());
  }
  function get_base64PadDecoded_0(_this__u8e3s4) {
    return decodeToString(get_base64PadDecodedBytes(_this__u8e3s4));
  }
  ...
  function get_base64UrlEncoded_0(_this__u8e3s4) {
    return Base64_getInstance().encodeToString_4ettju_k$(encodeToByteArray(_this__u8e3s4), UrlSafe_getInstance());
  }
  function get_base64UrlDecoded_0(_this__u8e3s4) {
    return decodeToString(get_base64UrlDecodedBytes(_this__u8e3s4));
  }
  function get_base64UrlDecodedBytes(_this__u8e3s4) {
    return Base64_getInstance().decode_xxjwh2_k$(_this__u8e3s4, UrlSafe_getInstance());
  }
  function get_base64UrlPadEncoded_0(_this__u8e3s4) {
    return Base64_getInstance().encodeToString_4ettju_k$(encodeToByteArray(_this__u8e3s4), UrlSafePad_getInstance());
  }
  function get_base64UrlPadDecoded_0(_this__u8e3s4) {
    return decodeToString(get_base64UrlPadDecodedBytes(_this__u8e3s4));
  }
  function get_base64UrlPadDecodedBytes(_this__u8e3s4) {
    return Base64_getInstance().decode_xxjwh2_k$(_this__u8e3s4, UrlSafePad_getInstance());
  }
  return _;
