(function (_, $module$bip39, $module$bip32, $module$elliptic, io_iohk_atala_prism_apollo_utils_external_BN_kz3vc8, kotlin_kotlin, kotlin_com_ionspin_kotlin_bignum, kotlin_io_iohk_atala_prism_utils) {
  'use strict';
  ...
  var endsWith$default = kotlin_kotlin.$_$.g;
  ...
  var Exception_init_$Init$ = kotlin_kotlin.$_$.t;
  ...
  var toTypedArray = kotlin_kotlin.$_$.y4;
  ...
  function $jsExportAll$(_) {
    ...
    $io$iohk$atala$prism$apollo$utils.JsHashType.values = values;
    $io$iohk$atala$prism$apollo$utils.JsHashType.valueOf = valueOf;
  ...
  _.$_$ = _.$_$ || {};
  _.$_$.a = ECConfig_getInstance;
  //endregion
  return _;
}(module.exports, require('bip39'), require('bip32'), require('elliptic'), require('bn.js'), require('./kotlin-kotlin-stdlib-js-ir.js'), require('./KotlinBigInteger-bignum-js-ir.js'), require('./ApolloUtils.js')));
