(function (_, kotlin_io_iohk_atala_prism_base64, kotlin_kotlin, kotlin_io_iohk_atala_prism_secure_random, kotlin_io_iohk_atala_prism_utils) {
  'use strict';
  ...
  //endregion
  return _;
}(module.exports, require('./ApolloBase64.js'), require('./kotlin-kotlin-stdlib-js-ir.js'), require('./ApolloSecureRandom.js'), require('./ApolloUtils.js')));
