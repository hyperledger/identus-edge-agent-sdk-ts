...
[![Coverage Status](https://coveralls.io/repos/github/input-output-hk/identus-edge-agent-sdk-ts/badge.svg?branch=master)](https://coveralls.io/github/input-output-hk/identus-edge-agent-sdk-ts?branch=master)
...
* [Edge Agent SDK TS](https://github.com/input-output-hk/identus-edge-agent-sdk-ts) - Repo for the Typescript version of the SDK.

We also have edge agents for other platforms:
* [Edge Agent SDK Swift](https://github.com/input-output-hk/identus-edge-agent-sdk-swift) - Repo for the Swift version of the SDK.
* [Edge Agent SDK KMP](https://github.com/input-output-hk/identus-edge-agent-sdk-kmm) - Repo for the Kotlin Multi-Platform version of the SDK.

## SDK Overview

- Apollo: Provides a suite of necessary cryptographic operations.
- Castor: Provides a suite of operations to create, manage and resolve decentralized identifiers.
- Pollux: Provides a suite of operations for handling [verifiable credentials](https://github.com/input-output-hk/identus-docs/blob/master/documentation/docs/concepts/glossary.md#verifiable-credentials).
...
```
git clone git@github.com:input-output-hk/identus-edge-agent-sdk-ts.git --recruse-submodules
```
