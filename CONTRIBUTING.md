...
The SDK TS will help adoption within TS platforms (Browser/Node) by providing key functionalities. For more information, please have a look at the [Readme](https://github.com/hyperledger-identus/sdk-ts/blob/master/README.md)

### Your First Code Contribution

Unsure where to begin contributing to the SDK? You can start by looking through the [Readme](https://github.com/hyperledger-identus/sdk-ts/blob/master/README.md) that provides all the steps to setup your environment.
...
* **Check the [Readme](https://github.com/hyperledger-identus/sdk-ts/blob/master/README.md) ** if you have problems with the setup and the [discussions](https://github.com/hyperledger-identus/sdk-ts/discussions)** for a list of common questions and problems.
