...
export function issuerCreateSchema(): number;
export function issuerCreateCredentialOffer(a: number, b: number): void;
export function issuerCreateCredential(a: number, b: number, c: number, d: number): number;
