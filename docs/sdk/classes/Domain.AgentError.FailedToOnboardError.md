[@input-output-hk/atala-prism-wallet-sdk](../README.md) / [Exports](../modules.md) / [Domain](../modules/Domain.md) / [AgentError](../modules/Domain.AgentError.md) / FailedToOnboardError
...
• **new FailedToOnboardError**(`message?`, `options?`): [`FailedToOnboardError`](Domain.AgentError.FailedToOnboardError.md)
