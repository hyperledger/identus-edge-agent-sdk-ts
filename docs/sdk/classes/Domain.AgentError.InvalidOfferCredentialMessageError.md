[@input-output-hk/atala-prism-wallet-sdk](../README.md) / [Exports](../modules.md) / [Domain](../modules/Domain.md) / [AgentError](../modules/Domain.AgentError.md) / InvalidOfferCredentialMessageError
...
• **new InvalidOfferCredentialMessageError**(`message?`, `options?`): [`InvalidOfferCredentialMessageError`](Domain.AgentError.InvalidOfferCredentialMessageError.md)
