[@input-output-hk/atala-prism-wallet-sdk](../README.md) / [Exports](../modules.md) / [Domain](../modules/Domain.md) / [AgentError](../modules/Domain.AgentError.md) / NoConnectionOpenError
...
• **new NoConnectionOpenError**(`message?`, `options?`): [`NoConnectionOpenError`](Domain.AgentError.NoConnectionOpenError.md)
