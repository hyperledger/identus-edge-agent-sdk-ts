[@input-output-hk/atala-prism-wallet-sdk](../README.md) / [Exports](../modules.md) / [Domain](../modules/Domain.md) / [PlutoError](../modules/Domain.PlutoError.md) / DatabaseConnectionError
...
• **new DatabaseConnectionError**(`message?`, `options?`): [`DatabaseConnectionError`](Domain.PlutoError.DatabaseConnectionError.md)
