[@input-output-hk/atala-prism-wallet-sdk](../README.md) / [Exports](../modules.md) / [Domain](../modules/Domain.md) / [PlutoError](../modules/Domain.PlutoError.md) / InvalidCredentialJsonError
...
• **new InvalidCredentialJsonError**(`message?`, `options?`): [`InvalidCredentialJsonError`](Domain.PlutoError.InvalidCredentialJsonError.md)
