[@input-output-hk/atala-prism-wallet-sdk](../README.md) / [Exports](../modules.md) / [Domain](../modules/Domain.md) / [AgentError](../modules/Domain.AgentError.md) / InvitationIsInvalidError
...
• **new InvitationIsInvalidError**(`message?`, `options?`): [`InvitationIsInvalidError`](Domain.AgentError.InvitationIsInvalidError.md)
