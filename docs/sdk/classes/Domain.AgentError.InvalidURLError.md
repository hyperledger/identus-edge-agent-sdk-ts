[@input-output-hk/atala-prism-wallet-sdk](../README.md) / [Exports](../modules.md) / [Domain](../modules/Domain.md) / [AgentError](../modules/Domain.AgentError.md) / InvalidURLError
...
• **new InvalidURLError**(`message?`, `options?`): [`InvalidURLError`](Domain.AgentError.InvalidURLError.md)
