...
export class DIDAbnfParser extends Parser {
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    DIDAbnfParser._LITERAL_NAMES,
    DIDAbnfParser._SYMBOLIC_NAMES,
    []
  );
  ...
  public method_name(): Method_nameContext {
    let _localctx: Method_nameContext = new Method_nameContext(
      this._ctx,
      this.state
    );
          ...
          {
            {
              ...
              _la = this._input.LA(1);
              if (
                !(_la === DIDAbnfParser.ALPHA || _la === DIDAbnfParser.DIGIT)
              ) {
  ...
  public method_specific_id(): Method_specific_idContext {
    let _localctx: Method_specific_idContext = new Method_specific_idContext(
      this._ctx,
      this.state
    );
  ...
  public static get _ATN(): ATN {
    if (!DIDAbnfParser.__ATN) {
      DIDAbnfParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(DIDAbnfParser._serializedATN)
      );
    }
...
export class IdcharContext extends ParserRuleContext {
  public ALPHA(): TerminalNode | undefined {
    return this.tryGetToken(DIDAbnfParser.ALPHA, 0);
  }
  public DIGIT(): TerminalNode | undefined {
  ...
  public PCT_ENCODED(): TerminalNode | undefined {
