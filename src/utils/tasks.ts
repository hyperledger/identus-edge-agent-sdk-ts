...
/**
 * used for a bit of TS hackery to enable Context extension
 */
...
export namespace Task {
  ...
  /**
   * create a proxy so we can extend arbitrarily
   */
  class ContextProxy {
   ...
   * 
   */
  export type Context<T = {}> = ContextProxy & Required<Context.Base> & Extension & T;
