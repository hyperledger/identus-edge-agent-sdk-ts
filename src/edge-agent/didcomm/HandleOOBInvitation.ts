...
export class HandleOOBInvitation extends Task<void, Args> {
  async run(ctx: DIDCommContext) {
    ...
    if (isNil(attachedMsg)) {
      ...
      // TODO we just assume connection is made - this could fail and should be handled
      // TODO OutOfBandInvitation piuri = didcomm.org, Handshake is Atalaprism.io - is this to didcomm spec
      ...
      // ? is there a return message sent to ack the connection
      ...
      // TODO update events to use Connections not pairs
