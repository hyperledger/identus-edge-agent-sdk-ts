...
export class ECConfig {
  ...
  private static readonly PUBLIC_KEY_COORDINATE_BYTE_SIZE: number = 32;
  private static readonly PUBLIC_KEY_COMPRESSED_BYTE_SIZE: number =
  ...
  private static readonly p = new BN(
    "115792089237316195423570985008687907853269984665640564039457584007908834671663",
    10
  );
  private static readonly b = new BN("7");

  // n curve order (The order of secp256k1 is n)
  private static readonly n = new BN(
